...
#pragma region Git
	UPROPERTY(Config, EditAnywhere, Category = "Git|Branch Parsing")
	...
	UPROPERTY(Config, EditAnywhere, Category = "Git|Commit Parsing")
	...
	UPROPERTY(Config, EditAnywhere, Category = "Git|Date Parsing")
	...
	UPROPERTY(Config, EditAnywhere, Category = "Git|Changes Parsing")
